...
public class RobotContainer {
  ...
  private RobotContainer() {
    ...
    SmartDashboard.putNumber("Fiducial #",2);  // 
  ...
  final JoystickButton timeDriveButton = new JoystickButton(joystick, 10);
  timeDriveButton.whileTrue( new AutoSequence1(m_driveTrain, m_sweeper).withTimeout(11));    
//  timeDriveButton.whileTrue( new Drive4Time(m_driveTrain, 0.6, 0.2).withTimeout(5));    
